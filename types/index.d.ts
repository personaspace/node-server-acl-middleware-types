 ...
 */
export declare type ResourceACLMiddlewareExec = (request: Partial<IncomingMessage>, ...params: any[]) => boolean;
/**
 * A type used to validate input values. Is either a regular expression or a
 * function accepting a single argument.
 */
export declare type ResourceACLMiddlewareFormInputValidator = RegExp | ((value: any) => boolean);
/**
 ...
 */
export declare type ResourceACLMiddlewareParamHandler = (formValues: Array<string | number | boolean>, formObject?: IResourceACLMiddlewareFormInput[]) => string | number | boolean;
/**
